...
\pagestyle{fancy}
\fancyhf{}
\lhead{\textbf{DM de mathématiques -- Niveau Terminale}}
...
% ========================= EXERCICE 1 =========================
\section*{Exercice 1 -- Fonction et résolution d'équations \hfill /5}
...
\begin{itemize}[leftmargin=1.2cm]
    ...
    \item Résoudre \(f(x)=0\), c'est chercher les valeurs de \(x\) pour lesquelles l'expression vaut \(0\).
